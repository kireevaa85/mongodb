...
public class Demo {
    ...
    private void insertAndFind(MongoCollection<Document> collection) throws Throwable {
        ...
        SubscriberHelpers.ObservableSubscriber<Success> subscriber = new SubscriberHelpers.ObservableSubscriber<>();
        collection.insertOne(doc).subscribe(subscriber);
        subscriber.await();

        SubscriberHelpers.ObservableSubscriber<Document> subscriberPrinter = new SubscriberHelpers.ObservableSubscriber<>();
